...
object PlantData {
    ...
    Plant(
        ...
        details = "The Philodendron Brasil is a stunning variety of the classic heartleaf philodendron, featuring glossy, heart-shaped leaves with dramatic splashes of lime yellow and chartreuse variegation against deep green. Native to Central America and the Caribbean, wild philodendrons are climbing plants that use aerial roots to scale trees in tropical rainforests. This fast-growing trailing plant is perfect for hanging baskets, shelves, or trained to climb a moss pole. The vines can grow several meters per year under ideal conditions, and the plant becomes more impressive with age. Philodendrons are among the easiest plants to propagate—simply cut below a node and place in water to root. Regular pruning encourages bushier growth and provides plenty of cuttings to share or expand your collection.",
